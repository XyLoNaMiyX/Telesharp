...
namespace TLSharp.Core.MTProto
{
    ...
    public class TL
    {
        ...
        public static readonly Dictionary<uint, Type> Constructors = new Dictionary<uint, Type>()
        {
            ...
            { 0x67e1255f, typeof(ChannelsMessageEditDataType) },
        ...
        {
            public override uint ConstructorCode => 0x27ea3a28;
        ...
        {
            public override uint ConstructorCode => 0xdcda80ed;
        ...
        {
            public override uint ConstructorCode => 0x317ceef4;
        ...
        {
            public override uint ConstructorCode => 0x67e1255f;
